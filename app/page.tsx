  ...
  return (
    <div className="flex flex-col min-h-screen">
              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Button asChild size="lg">
                    <Link href="/interviews/new">Get Started</Link>
                  </Button>
                  <Button asChild variant="outline" size="lg">
                    <Link href="/dashboard">View Interviews</Link>
                  </Button>
                </div>
              </div>
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3 lg:gap-12">
              <div className="flex flex-col items-center space-y-2 text-center">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Practice with video recording to simulate real interview conditions
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 text-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-primary/10">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Get detailed feedback and improvement suggestions from our AI
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 text-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-full bg-primary/10">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Customize interviews for your specific industry and role
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2023 MockInterview. All rights reserved.</p>
